...
! function(e, t) {
    ...
    function g(e) {
        ...
        if (!r) e: {
            for (e = d(e); i(e) && 0 > ["html", "body"].indexOf(a(e));) {
                if ("none" !== (r = c(e)).transform || "none" !== r.perspective || "auto" !== r.willChange) {
                    r = e;
                    break e
                }
                e = e.parentNode
    ...
    function x(e) {
        ...
        return function(e, t, i) {
            ...
            return O(e, t) ? (p.setOptions(i).then((function(e) {
    ...
    function j(e) {
        ...
        if (null != (r = r ? w(r) : null)) switch (i = "y" === r ? "height" : "width", e) {
            case "start":
    ...
    function L(e, o) {
        if ("viewport" === o) {
            ...
            var l = 0,
                u = 0;
            o && (p = o.width, a = o.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (l = o.offsetLeft, u = o.offsetTop)), e = k(e = {
                width: p,
                height: a,
                x: l + f(e),
                y: u
    ...
    function B(e, t, n) {
        return t = "clippingParents" === t ? function(e) {
            ...
            return n = L(e, n), t.top = Math.max(n.top, t.top), t.right = Math.min(n.right, t.right), t.bottom = Math.min(n.bottom, t.bottom), t.left = Math.max(n.left, t.left), t
    ...
    function H(e, n) {
        ...
        c = e.rects.popper, a = B(o(p = e.elements[p ? "popper" === i ? "reference" : "popper" : i]) ? p : p.contextElement || s(e.elements.popper), a, f), p = j({
            reference: f = t(l),
            element: c,
            strategy: "absolute",
            placement: n
        }), c = k(Object.assign(Object.assign({}, c), p)), f = "popper" === i ? c : f;
        var u = {
        ...
        F = [{
            ...
            fn: function(e) {
                ...
                e = void 0 === (e = n.gpuAcceleration) || e, n = void 0 === (n = n.adaptive) || n, e = {
                    ...
                    gpuAcceleration: e
                }, null != t.modifiersData.popperOffsets && (t.styles.popper = Object.assign(Object.assign({}, t.styles.popper), M(Object.assign(Object.assign({}, e), {}, {
                    offsets: t.modifiersData.popperOffsets,
                    position: t.options.strategy,
                    adaptive: n
                })))), null != t.modifiersData.arrow && (t.styles.arrow = Object.assign(Object.assign({}, t.styles.arrow), M(Object.assign(Object.assign({}, e), {}, {
            ...
            fn: function(e) {
                ...
                if (e = e.name, !t.modifiersData[e]._skip) {
                    ...
                    for (var h = d[0], g = 0; g < d.length; g++) {
                        ...
                        if (O = x ? O ? "right" : "left" : O ? "bottom" : "top", n[w] > i[w] && (O = E(O)), w = E(O), x = [], r && x.push(0 >= j[v]), o && x.push(0 >= j[O], 0 >= j[w]), x.every((function(e) {
                                return e
                            }))) {
                            h = b, p = !1;
                            break
    ...
    e.createPopper = X, e.defaultModifiers = F, e.detectOverflow = H, e.popperGenerator = x, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}));
